...
global {
	...
	float min_production_ecolabel <- 3000.0;
	float max_pollution_ecolabel <- 300000.0;
	...
	float communal_landfill_waste_pollution_impact_rate <- 0.1/ factor_productivity;  //impact of pollution generated by the communal landfill on productivity of fields: production (yield) = production  - (pollution of the surrounding communal landfill * communal_landfill_waste_pollution_impact_rate)
