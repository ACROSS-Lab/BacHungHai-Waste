...
global {
	...
	float quantity_communal_landfill_to_treatment <- 900.0; //quantity of solid waste "treated" (that disapears) every day from the communal landfill
	...
	float part_solid_waste_canal_inhabitants <- 0.2; // proportion of solid waste throw in the canal per people living in urban area; (1 - part_solid_waste_canal_inhabitants) is throw on the ground
