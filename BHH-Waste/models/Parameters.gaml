...
global {
	...
	list<float> improve_of_fallow_on_productivity <- [0.75, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1]; //at T+1 -> Improve the productivity of 50 % at T+1, then of 25 % at T+2, and 0% after
