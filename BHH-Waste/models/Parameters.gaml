...
global {
	...
	float ground_solid_waste_pollution_impact_rate <- 0.1; //production (yield) = production  - (sum solid pollution on cell * pollution_impact_rate)
	...
	float quantity_communal_landfill_to_treatment <- 1350.0; //quantity of solid waste "treated" (that disapears) every day from the communal landfill
