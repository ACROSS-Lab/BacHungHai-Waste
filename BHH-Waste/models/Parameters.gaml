...
/******************* GEOGRAPHICAL DATA USED *************************************/
	...
	float quantity_from_local_to_communal_landfill <- 300.0; //quantity of solid waste transfert to communal landfill every day for each local landfill 
	float quantity_communal_landfill_to_treatment <- 1020.0; //quantity of solid waste "treated" (that disapears) every day from the communal landfill
